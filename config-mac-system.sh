...
# Set a moderately fast keyboard repeat rate
...
/usr/libexec/PlistBuddy -c "Set :FK_StandardViewSettings:IconViewSettings:iconSize 54" ~/Library/Preferences/com.apple.finder.plist
/usr/libexec/PlistBuddy -c "Set :StandardViewSettings:IconViewSettings:iconSize 54" ~/Library/Preferences/com.apple.finder.plist
...
echo ""
echo "Done. Note that some of these changes may srequire a logout/restart to take effect."

echo ""
echo "Configuration finished in $(printf '%02dh:%02dm:%02ds\n' $(($SECONDS/3600)) $(($SECONDS%3600/60)) $(($SECONDS%60)))"
echo ""